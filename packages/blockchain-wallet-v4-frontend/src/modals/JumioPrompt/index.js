    ...
    return (
      ...
      >
        <ModalHeader onClose={close}>
          <Text>
            <FormattedMessage
              id='modals.jumioprompt.header'
              defaultMessage='Speed Up Your Bitcoin Purchase'
            />
          </Text>
        </ModalHeader>
        <ModalBody>
          <Text weight={300}>
            <FormattedMessage
              id='modals.jumioprompt.body1'
              defaultMessage='By verifying your identity, your limit will be higher and you will get your bitcoin faster!'
            />
          </Text>
          <ButtonRow>
            <ButtonWrapper>
